...
public class ScoreboardHelper
{
   ...
   public ScoreboardHelper(final Scoreboard scoreboard2, final String title) {
   ...
   public void update(final Player player) {
    ...
    private Team getOrCreateTeam(final String team, final int i) {
    ...
    private Objective getOrCreateObjective(final String objective) {
    ...
    private String getNameForIndex(final int index) {
